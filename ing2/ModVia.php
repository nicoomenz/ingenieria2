	...
	<body>
     <?php
	  ...
	  <header>
		...
		<form class="regV" action="ModViaAct.php" method="post" enctype="multipart/form-data" >
			...
			<div class="form-group">
				...
				<input type="time" class="form-control" id="texto4" name="hora" placeholder="Ingresá la fecha en la que viajas" value="<?php echo $registro['hora'] ?>">
			</div>
                        </div>
				<div class="form-group">
				<label for="texto5" ><h5>Hora de llegada</h5></label>
				<input type="time" class="form-control" id="texto5" name="hora2" placeholder="Ingresá la fecha en la que viajas" value="<?php echo $registro['horaLlegada'] ?>">
			</div>
			<div class="form-group">
