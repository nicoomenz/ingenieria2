	...
	<body>
		...
		<?php
          ...
          if($resultadoConsultaPi=mysqli_query($conexion,$consultaPiloto)){
          	$registroPilo=mysqli_fetch_array($resultadoConsultaPi);
          ...
          if($resultadoConsulta=mysqli_query($conexion,$consulta)){
            if($resultadoConsulta2=mysqli_query($conexion,$consulta2)){
          	  ...
          	  if($registro44[0] != ''){
                  $registro2=mysqli_fetch_array($resultadoConsulta);
                  echo $viaje=$registro2['id_viaje'];
			 ...
			 echo"</table>";
           	  ...
           	  echo "<label class='noPoseeVeh'><h3> No posee ningun viajes registrado.</h3></label>";
           }
       }
